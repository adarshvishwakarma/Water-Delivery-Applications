...
public class OrdersActivity extends AppCompatActivity {
    ...
    public static class OrderedItemHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.orderedShopName)
        TextView mOrderedShopName;
        ...
        LinearLayout layout;
        @BindView(R.id.orderedShopImage)
        ImageView mOrderedShopImage;
